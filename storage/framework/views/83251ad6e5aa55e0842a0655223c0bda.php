<?php $__env->startSection('title', 'Новая квартира'); ?>
...
<form method="post" action="<?php echo e(route('cabinet.projects.apartments.store', $project)); ?>">
    <?php echo csrf_field(); ?>
    <div class="row g-3">
        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('apartment_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('floor')); ?>" min="0" max="999">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('living_area')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('rooms_count')); ?>" min="1" max="20">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-3">
        ...
        <a href="<?php echo e(route('cabinet.projects.show', $project)); ?>" class="btn btn-secondary">Отмена</a>
    </div>
</form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('cabinet.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/client-management-crm/resources/views/cabinet/apartments/create.blade.php ENDPATH**/ ?>