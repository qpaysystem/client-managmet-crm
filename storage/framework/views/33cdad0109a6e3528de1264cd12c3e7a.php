...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body py-3">
        <div class="d-flex flex-wrap align-items-center gap-3">
            <a href="<?php echo e(route('cabinet.tasks.create')); ?>" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i> Создать задачу</a>
            <form method="get" action="<?php echo e(route('cabinet.board')); ?>" class="d-flex align-items-center gap-2 flex-wrap">
                ...
                <select id="filter-responsible" name="responsible_id" class="form-select form-select-sm" style="min-width: 200px;" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $clients ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->id); ?>" <?php if(($filterResponsibleId ?? '') == $c->id || ($filterResponsibleId ?? '') == (string)$c->id): echo 'selected'; endif; ?>><?php echo e($c->first_name); ?> <?php echo e($c->last_name); ?></option>
...
<div class="row g-3 kanban-board" data-csrf="<?php echo e(csrf_token()); ?>" data-status-url-base="<?php echo e(url('/cabinet/tasks')); ?>">
            ...
            <div class="card-body p-2 kanban-drop-zone" style="min-height: 280px;">
                ...
                <div class="card mb-2 bg-white border kanban-task" draggable="true" data-task-id="<?php echo e($task->id); ?>">
                    <div class="card-body py-2 px-3">
                        ...
                        <?php if($task->client): ?>
                            <div class="small text-primary mt-1"><i class="bi bi-person me-1"></i><?php echo e($task->client->full_name); ?></div>
                        <?php endif; ?>
...
<?php echo $__env->make('cabinet.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/client-management-crm/resources/views/cabinet/board.blade.php ENDPATH**/ ?>