...
<form method="post" action="<?php echo e(route('admin.tasks.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select name="status" class="form-select">
            <?php $__currentLoopData = \App\Models\Task::statusLabels(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value); ?>" <?php if(old('status', 'in_development') === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div class="mb-3 form-check">
        <input type="checkbox" name="show_on_board" value="1" class="form-check-input" id="show_on_board" <?php if(old('show_on_board', true)): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/client-management-crm/resources/views/admin/tasks/create.blade.php ENDPATH**/ ?>