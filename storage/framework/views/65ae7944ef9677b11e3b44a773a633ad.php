...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Главная'); ?> — Периметр Элитного Капитала</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark navbar-landing py-3">
        <div class="container">
            <a class="navbar-brand fw-bold fs-5 text-white text-decoration-none" href="<?php echo e(url('/')); ?>">Периметр Элитного Капитала</a>
            ...
            <div class="collapse navbar-collapse" id="navbarLanding">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    <li class="nav-item"><a class="nav-link active" href="<?php echo e(url('/')); ?>">Главная</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/')); ?>#about">О компании</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/')); ?>#objects">Объекты</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/')); ?>#contact">Контакты</a></li>
                    <li class="nav-item btn-cabinet-wrap">
                        <a class="ms-lg-2" href="<?php echo e(route('cabinet.login')); ?>"><span class="btn btn-light btn-cabinet btn-sm"><i class="bi bi-box-arrow-in-right me-1"></i> Вход в личный кабинет</span></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container text-center">
            ...
            <p class="mb-0"><a href="<?php echo e(route('cabinet.login')); ?>" class="btn btn-outline-warning btn-sm min-touch">Вход в личный кабинет</a></p>
        </div>
    </footer>
...
<?php /**PATH /Users/evgeny/client-management-crm/resources/views/landing/layout.blade.php ENDPATH**/ ?>