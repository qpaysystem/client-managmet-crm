...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('registered_at', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-12">
            ...
            <select name="status" class="form-select">
                <option value="active" <?php echo e(old('status', 'active') === 'active' ? 'selected' : ''); ?>>Активный</option>
        ...
        <div class="col-12">
            <?php echo $__env->make('admin.clients._custom_field', ['field' => $f, 'value' => old('custom_'.$f->name)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    <div class="mt-4">
        <button type="submit" class="btn btn-primary">Создать</button>
        <a href="<?php echo e(route('admin.clients.index')); ?>" class="btn btn-secondary">Отмена</a>
    </div>
</form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/client-management-crm/resources/views/admin/clients/create.blade.php ENDPATH**/ ?>